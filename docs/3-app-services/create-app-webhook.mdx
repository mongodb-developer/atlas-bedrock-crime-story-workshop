...
1. Click "Insert" and wait for the data to be imported.
 <img
        ...
        border="1"
    />
1. Repeat the same process for the ["story.json"](https://github.com/mongodb-developer/atlas-bedrock-crime-story-demo) file in the "data" folder to load into "Story".
