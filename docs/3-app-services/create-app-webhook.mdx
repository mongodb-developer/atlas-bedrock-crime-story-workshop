...
1. Click "Insert Dumcument" or "Add My Own Data" (if present) and switch to the document view. Paste the content of the ["evidence.json"](https://raw.githubusercontent.com/mongodb-developer/atlas-bedrock-crime-story-demo/main/data/evidence.json) file from the "data" folder in the repository. 
