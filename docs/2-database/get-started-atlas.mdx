...
1. Use the following wizard to create a first user and passowrd. Finally take a note of your database user and password and for the sake of this workshop please have `0.0.0.0/0` temporarly whitelisted in the [IP Access List](https://www.mongodb.com/docs/atlas/security/ip-access-list/).
    <img
