...
1. Next, you need to configure your application.
    ...
    - **(Optional) Application Name**: Let’s give our application a meaningful name such as **bedrockDemo** (this option might be chosen for you automatically as "Application-0" for a first application).
